...
public class FlowerArea : MonoBehaviour
{
    ...
    //can only get from outside (we can only set inside)
    ...
    //Gets the Flower that a nectar collider belongs to. Collider is nectar collider. Return value is matching
    //flower. 
    //Throws exception if collider doesn't exist. 
    ...
    private void Start(){
        ...
        //Can't do this too soon (so not in awake)
        FindChildFlowers(transform);
    }

    //Recursively finds all flowers and flower plants that are children of a parent transform. Parameter is the parent of 
